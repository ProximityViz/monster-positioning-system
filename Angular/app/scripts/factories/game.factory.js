...
.factory('GameFactory', function() {
	...
	var getCurrentLegalClicks = function() {
		var legalClicks = [];
		for (var i = 0; i < gameBoard.length; i++) {
			var space = gameBoard[i];
			if (space.player === currentPlayer) {
				legalClicks.push(space);
			}
		}
	...
	return {
		...
		getCurrentLegalClicks: getCurrentLegalClicks, // might not use these outside the factory
